...
$path = (string) call_user_func($routePath, '/rawat-inap');
$riwayatPath = (string) call_user_func($routePath, '/riwayat-perawatan');
$resumePath = (string) call_user_func($routePath, '/rawat-inap/resume');

$buildUrl = static function (array $overrides) use ($path, $q, $dateMode, $dateFrom, $dateTo, $resumeStatus, $perPageFilter): string {
    $params = [
        'q' => $q,
        'dateMode' => $dateMode,
        'dateFrom' => $dateFrom,
            ...
            <form method="get" action="<?= \App\Helpers\App::e($path) ?>" class="rawat-inap-filters" id="rawatInapFilters">
                ...
                <div class="pt-4">
                    <a
                        ...
                        href="<?= \App\Helpers\App::e($buildUrl(['q' => '', 'dateMode' => 'belum_pulang', 'dateFrom' => null, 'dateTo' => null, 'resumeStatus' => 'all', 'page' => '1'])) ?>"
                    >
                        Reset
                    </a>
                </div>
